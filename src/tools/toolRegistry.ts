...
export const ADVANCED_ARCHITECTURE_TOOL_NAMES = [
  ...
  "run_foundry_eval_corpus", "forge_foundry_previews", "route_foundry_decisions", "score_foundry_actionability", "normalize_foundry_evidence", "derive_repo_constitution", "derive_local_repo_constitution",
