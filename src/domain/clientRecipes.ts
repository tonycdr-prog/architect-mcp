  ...
  const recipes = [
    {
      ...
      calls: [
        { tool: "interpret_implementation_intent", arguments: { request: "fix this with best practices", mode: "guided-yolo" } },
        { tool: "create_pre_edit_contract", when: "decision is confirm_before_edit or blastRadius is high" },
        { tool: "review_implementation_against_contract", when: "after files change" }
      ],
