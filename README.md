...
The package also exposes `architect-mcp-tui`, a Ratatui client for local work-gate sessions, adapter readiness, safe headless automation, approval/promotion commands, arena ranking, private-by-default repo-foundry staging, and provisional ACP:
